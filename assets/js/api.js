...
window.CollegeOSApi = {
  ...
  adminControlLiveHubVisibility: () => apiFetch('/api/admin/control/live-hub-visibility'),
  adminControlUpdateLiveHubVisibility: (payload) => apiFetch('/api/admin/control/live-hub-visibility', { method: 'PUT', body: JSON.stringify(payload) }),
  getLiveHubStatus: () => apiFetch('/api/dashboard/live-hub/status'),
